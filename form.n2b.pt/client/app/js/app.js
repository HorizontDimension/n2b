...
config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/upgrade', {templateUrl: '/partials/upgrade.html', controller: 'upgrade'});
    $routeProvider.when('/transfer', {templateUrl: '/partials/transfer.html', controller: 'transfer'});
